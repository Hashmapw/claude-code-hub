...
const nextConfig: NextConfig = {
  ...
  // Force Next to treat this package as the workspace root even when parent dirs
  // contain lockfiles; otherwise build artifacts may be emitted outside this app.
