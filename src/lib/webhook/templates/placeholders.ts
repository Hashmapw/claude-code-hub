...
export const TEMPLATE_PLACEHOLDERS = {
  ...
  vip_group_usage: [
    { key: "{{user_id}}", label: "用户ID", description: "触发请求的用户 ID" },
    { key: "{{user_name}}", label: "用户名", description: "触发请求的用户名称" },
    { key: "{{provider_id}}", label: "供应商ID", description: "命中的供应商 ID" },
    { key: "{{provider_name}}", label: "供应商名称", description: "命中的供应商名称" },
    { key: "{{provider_group_tag}}", label: "供应商分组", description: "命中的供应商分组" },
    { key: "{{model}}", label: "模型", description: "请求模型" },
    { key: "{{session_id}}", label: "会话ID", description: "请求会话 ID" },
  ],
  cache_hit_rate_alert: [
