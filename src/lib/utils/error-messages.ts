...
export const VALIDATION_ERRORS = {
  ...
  STREAM_PREFIX_BLOCK_DESCRIPTION_OBJECT_REQUIRED:
    "STREAM_PREFIX_BLOCK_DESCRIPTION_OBJECT_REQUIRED",
  STREAM_PREFIX_BLOCK_DESCRIPTION_INVALID_JSON: "STREAM_PREFIX_BLOCK_DESCRIPTION_INVALID_JSON",
  STREAM_PREFIX_BLOCK_SCAN_LIMIT_INVALID: "STREAM_PREFIX_BLOCK_SCAN_LIMIT_INVALID",
  STREAM_PREFIX_BLOCK_KEYWORDS_INVALID: "STREAM_PREFIX_BLOCK_KEYWORDS_INVALID",
  STREAM_PREFIX_BLOCK_PROVIDER_IDS_INVALID: "STREAM_PREFIX_BLOCK_PROVIDER_IDS_INVALID",
  STREAM_PREFIX_BLOCK_STATUS_CODE_INVALID: "STREAM_PREFIX_BLOCK_STATUS_CODE_INVALID",
  STREAM_PREFIX_BLOCK_MESSAGE_INVALID: "STREAM_PREFIX_BLOCK_MESSAGE_INVALID",
  KEY_SOFT_BLOCK_MESSAGE_TOO_LONG: "KEY_SOFT_BLOCK_MESSAGE_TOO_LONG",
  KEY_SOFT_BLOCK_MESSAGE_REQUIRED: "KEY_SOFT_BLOCK_MESSAGE_REQUIRED",
} as const;
...
export const AUTH_ERRORS = {
  ...
  PROXY_USER_DISABLED: "PROXY_USER_DISABLED",
  PROXY_USER_EXPIRED: "PROXY_USER_EXPIRED",
  PROXY_KEY_SOFT_BLOCKED: "PROXY_KEY_SOFT_BLOCKED",
  STREAM_PREFIX_BLOCKED: "STREAM_PREFIX_BLOCKED",
} as const;
...
export const BUSINESS_ERRORS = {
  ...
  KEY_SOFT_BLOCK_REDIS_UNAVAILABLE: "KEY_SOFT_BLOCK_REDIS_UNAVAILABLE",
  KEY_SOFT_BLOCK_SAVE_FAILED: "KEY_SOFT_BLOCK_SAVE_FAILED",
  KEY_SOFT_BLOCK_PARTIAL_FAILURE: "KEY_SOFT_BLOCK_PARTIAL_FAILURE",
  VIP_GROUP_USAGE_CONFIG_REDIS_UNAVAILABLE: "VIP_GROUP_USAGE_CONFIG_REDIS_UNAVAILABLE",
  VIP_GROUP_USAGE_CONFIG_SAVE_FAILED: "VIP_GROUP_USAGE_CONFIG_SAVE_FAILED",
  NOTIFICATION_SETTINGS_PARTIAL_FAILURE: "NOTIFICATION_SETTINGS_PARTIAL_FAILURE",
} as const;
